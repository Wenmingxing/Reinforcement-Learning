...
The Sarsa RL maze environment example.

Red rectangle : explorer.
Black rectangles : hells [rewards = -1] 
Yellow bin circles : paradise [rewards = +1]
...
class Maze(tk.Tk):
	...
	def step(self,action):
		...
		if action == 0: # up
			...
			if s[0] > UNIT:
				base_action[0] -= UNIT
		self.canvas.move(self.rect,base_action[0],base_action[1]) # move_agent
