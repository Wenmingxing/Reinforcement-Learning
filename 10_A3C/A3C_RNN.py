...
'''
Coded by Luke Wen on 2nd Nov 2017, aiming to get familiar with A3C (Asynchronous Advantage Actor Critic) Reinforcement learning. 

Here we'll also use the RNN for the Pendulum example.
