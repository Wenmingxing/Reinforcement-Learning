...
'''
Coded by Luke Wen On 22th Oct 2017, aiming to get familiar with Deep Deterministic Policy Gradient.
...
# DDPG (Deep Deterinistic Policy Gradient) experience replay & Fixed target value network.
...
class DDPG(object):
	def __init__(self, a_dim, s_dim, a_bound):
		...
		tf_error = tf.losses.mean_squared_error(labels = q_target, predictions = q)
		self.ctrain = tf.train.AdamOptimizer(LR_C).minimize(tf_error,var_list = self.ce_params)
